...
class NewsletterResumeExecutionWizard(models.TransientModel):
    _name = "newsletter.resume.execution.wizard"
    _description = "Resume Newsletter Campaign Execution"
    ...
    def action_confirm(self):
        self.ensure_one()
        self.campaign_run_id.action_resume(reason=self.reason)

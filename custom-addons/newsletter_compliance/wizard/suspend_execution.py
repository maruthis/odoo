...
class NewsletterSuspendExecutionWizard(models.TransientModel):
    _name = "newsletter.suspend.execution.wizard"
    _description = "Suspend Newsletter Campaign Execution"
    ...
    def action_confirm(self):
        self.ensure_one()
        self.campaign_run_id.action_suspend(reason=self.reason)
